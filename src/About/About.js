        ...
        <div className='row pt-5'>
          ...
          <div className='col-12 col-md-6 col-lg-6 aboutTextPart text-white' data-aos="fade-left">
            <div>
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>1/159A, North Soorankudy (PO), Nagercoil, Kanniyakumari - 629501</td>
                  </tr>
                  <tr>
              ...
              <a  href="/pdf/Praveen-KN.pdf"download="Praveen-KN.pdf"   className="btn downloadcv mt-4" > Download CV </a>
            </div>
          </div>
        </div>
      </div>
